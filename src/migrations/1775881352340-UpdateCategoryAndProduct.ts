...
export class UpdateCategoryAndProduct1775881352340 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "product" ADD CONSTRAINT "FK_d7cf9c55e1fc04c672ce0f524b0" FOREIGN KEY ("category_slug") REFERENCES "category"("slug") ON DELETE NO ACTION ON UPDATE NO ACTION'
    )
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "product" ADD CONSTRAINT "FK_0dce9bc93c2d2c399982d04bef1" FOREIGN KEY ("category_id") REFERENCES "category"("category_id") ON DELETE NO ACTION ON UPDATE NO ACTION'
    )
  }
}
